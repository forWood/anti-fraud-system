...
/**
 * Java 8 兼容的 Map 构造工具类
 *
 * 替代 Java 9+ 的 Map.of() 方法
 */
public final class MapBuilder {
    ...
    /**
     * 嵌套 Map (外层4键，内层3键)
     * 替代 Map.of("code", 0, "data", Map.of(...))
     */
    public static <K, V> Map<K, V> ofNested(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        Map<K, V> map = new HashMap<>(8);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
